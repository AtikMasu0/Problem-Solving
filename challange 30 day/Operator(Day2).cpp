...
void solve(double meal_cost, int tip_percent, int tax_percent) {
    double  temp_tip_percent = (meal_cost/100)*tip_percent;
    double  temp_tax_percent = (meal_cost/100)*tax_percent;
    double  total_cost = meal_cost + temp_tax_percent + temp_tip_percent;
